...
export const translations = {
  en: {
    ...
    auth: {
      ...
      notReceivedSms: 'Not received SMS?',
      checkEmailToo: 'Check your email too.',
  ...
  si: {
    ...
    auth: {
      ...
      otpSentTo: 'සත්‍යාපන කේතය යවන ලද්දේ',
      notReceivedSms: 'SMS ලැබුණේ නැද්ද?',
      checkEmailToo: 'ඔබගේ ඊමේල් එකත් බලන්න.',
