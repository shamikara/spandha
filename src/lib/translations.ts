...
export const translations = {
  en: {
    ...
    auth: {
      ...
      otpSentSms: 'We sent your verification code by SMS.',
      otpSentEmail: 'We sent your verification code by email.',
      otpSentSmsAndEmail: 'We sent your verification code by SMS and email.',
  ...
  si: {
    ...
    auth: {
      ...
      otpSent: 'අපි ඔබට සත්‍යාපන කේතයක් යවා ඇත.',
      otpSentSms: 'අපි ඔබගේ සත්‍යාපන කේතය SMS මගින් යවා ඇත.',
      otpSentEmail: 'අපි ඔබගේ සත්‍යාපන කේතය ඊමේල් මගින් යවා ඇත.',
      otpSentSmsAndEmail: 'අපි ඔබගේ සත්‍යාපන කේතය SMS සහ ඊමේල් මගින් යවා ඇත.',
